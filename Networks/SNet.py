...
def SNet_3L(inputs, batch, output_type, learn_reg=1e-2):
    # Variables
    l2 = L2(learn_reg)
...
def SNet_3L_p(inputs, batch, output_type, learn_reg=1e-2):
    # Variables
    l2 = L2(learn_reg)
...
def SNet_3Lite(inputs, batch, output_type, learn_reg=1e-2):
    # Variables
    l2 = L2(learn_reg)
