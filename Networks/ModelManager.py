...
class ModelManager:
    ...
    def _load_nn(self, learn_reg, verbose=1):
        ...
        if self.model == "HelperNetV1":
            ...
            self.nn = Model(inputs, SNet_3L_p(inputs, self.dim[0], self.output_type, learn_reg))
        ...
        elif self.model == "UNetplusplus_3L":
            self.nn = Model(inputs, UNetplusplus_3L(inputs, learn_reg))
        else:
