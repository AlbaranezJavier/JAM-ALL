...
import numpy as np
from Networks.ViT import ViTB_keras_blocked
...
if __name__ == '__main__':
    ...
    tm = TrainingModel(nn=ViTB_keras_blocked(inputs_dim=input_dims,
                                             num_classes=6),
    ...
    ts = TrainingStats(model_name=model + id_copy,
                       ...
                       logs_name=f"{model}/cls/Raabin/{input_dims[1]}x{input_dims[2]}/batch_{input_dims[0]}/AdamW/{lr}/{end_epoch}",
                       start_epoch=start_epoch)
